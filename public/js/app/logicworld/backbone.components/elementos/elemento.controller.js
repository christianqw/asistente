    ...
    function ($, _, Marionette, JQUI, ElementoModel, ElementoView, ConjuntoModel, ConjuntoView) {
        ...
        var ElementoController = Marionette.Controller.extend({
          ...
          initialize: function () {
              ...
              this.listenTo(App.event_aggregator, 'elemento.editElement', this.editElement);
              this.listenTo(App.event_aggregator, 'elemento.changeFocus', this.changeFocus);
          },
